...
`
    ...
    let r = Object.getPrototypeOf(async function () {}).constructor,
      ...
      o = (() => {
        try {
          ...
          return (
            Object.defineProperty(s, "name", { value: `[Alpine] ${t}` }), s
          );
        } catch (s) {
  ...
  function ft(t, e, r, n, i) {
    if (it && typeof e == "function") {
      ...
      o instanceof Promise
        ? o.then((s) => ft(t, s, r, n)).catch((s) => nt(s, i, e))
        : t(o);
    } else
  ...
  var Nt =
      (t, e) =>
      ({ name: r, value: n }) => (
        r.startsWith(t) && (r = r.replace(t, e)), { name: r, value: n }
      ),
    Pt = (t) => t;
  function wr(t = () => {}) {
      ...
      xr(r) ||
        n.some((i) => {
          if (document.querySelector(i))
            return E(`found "${i}", but missing ${e} plugin`), !0;
        });
    });
  }
  var Ee = [],
  ...
  function Jn(t, e) {
    ...
    return (
      ...
      () => {
        o.forEach((s) => t.classList.add(s)),
          i.forEach((s) => t.classList.remove(s));
      }
    );
  }
  function X(t, e) {
  ...
  function ti(t, e, r) {
    ...
    e.includes("in") && !n && (e = e.filter((w, tt) => tt < e.indexOf("out"))),
      e.includes("out") &&
        !n &&
        (e = e.filter((w, tt) => tt > e.indexOf("out")));
  ...
  var xi = Object.prototype.toString,
    ...
    Te = (t) => on(t).slice(8, -1);
  var Vt = (t) =>
    gi(t) && t !== "NaN" && t[0] !== "-" && "" + parseInt(t, 10) === t;
  var Ut = (t) => {
  ...
  function dn(t) {
    t.active &&
      (pn(t), t.options.onStop && t.options.onStop(), (t.active = !1));
  }
  var Ei = 0;
  function Si(t, e) {
    let r = function () {
  ...
  function M(t, e, r) {
    ...
    i || n.set(r, (i = new Set())),
      i.has($) ||
        ...
        $.deps.push(i),
        $.options.onTrack &&
          $.options.onTrack({ effect: $, target: t, type: e, key: r }));
  }
  ...
  function _n(t = !1, e = !1) {
    return function (n, i, o) {
      ...
      if (i === "__v_raw" && o === (t ? (e ? qi : bn) : e ? Ui : yn).get(n))
        return n;
      let s = U(n);
  ...
  function Ni(t = !1) {
    return function (r, n, i, o) {
      let s = r[n];
      if (!t && ((i = h(i)), (s = h(s)), !U(r) && De(s) && !De(i)))
        return (s.value = i), !0;
      let a = U(r) && Vt(n) ? Number(n) < r.length : bt(r, n),
        c = Reflect.set(r, n, i, o);
      return (
        r === h(o) &&
          (a ? Re(i, s) && K(r, "set", n, i, s) : K(r, "add", n, i)),
        c
      );
    };
  }
  ...
  function Wt(t, e = !1) {
    return (
      (t = t.__v_raw), !e && M(h(t), "iterate", Q), Reflect.get(t, "size", t)
    );
  }
  function an(t) {
    t = h(t);
  ...
  function cn(t, e) {
    ...
    return (
      r.set(t, e),
      o ? Re(e, s) && K(r, "set", t, e, s) : K(r, "add", t, e),
      this
    );
  }
  function ln(t) {
  ...
  function Gt(t, e) {
    return function (n, i) {
      let o = this,
        ...
        c = e ? Le : t ? $e : ke;
      return (
        !t && M(a, "iterate", Q), s.forEach((l, u) => n.call(i, c(l), c(u), o))
      );
    };
  }
  function Jt(t, e, r) {
      ...
      return (
        !e && M(o, "iterate", c ? Pe : Q),
        {
          next() {
            ...
            return b
              ? { value: f, done: b }
              : { value: a ? [u(f[0]), u(f[1])] : u(f), done: b };
          },
          [Symbol.iterator]() {
            return this;
          },
    ...
    return function (...e) {
      {
        ...
        console.warn(
          `${Me(t)} operation ${r}failed: target is readonly.`,
          h(this)
        );
      }
  ...
  x(
    "refs",
    (t) => (t._x_refs_proxy || (t._x_refs_proxy = P(Gi(t))), t._x_refs_proxy)
  );
  function Gi(t) {
    let e = [];
    return (
  ...
  function z(t, e, r, n) {
    ...
    return (
      ...
      r.includes("passive") &&
        (s.passive = r[r.indexOf("passive") + 1] !== "false"),
      (o = Be(r, o)),
      r.includes("prevent") &&
        (o = a(o, (c, l) => {
  ...
  function eo(t, e) {
    ...
    if (r.length === 0 || (r.length === 1 && Tn(t.key).includes(r[0])))
      return !1;
    ...
    (t, { modifiers: e, expression: r }, { effect: n, cleanup: i }) => {
      ...
      let c = () => {
        ...
        l = (d) => {
          let y;
          s((w) => (y = w)),
            Rn(y) ? y.set(d) : a(() => {}, { scope: { __placeholder: d } });
        };
      typeof r == "string" &&
        t.type === "radio" &&
        m(() => {
      ...
      if (k) L = () => {};
        ...
        let d = [],
          y = (w) => l(Qt(t, e, w, c()));
        if (
          (u && d.push(z(t, "change", e, y)),
          f && (d.push(z(t, "blur", e, y)), t.form))
        ) {
          let w = t.form,
            tt = () => y({ target: t });
          w._x_pendingModelUpdates || (w._x_pendingModelUpdates = []),
            ...
            i(() => {
              w._x_pendingModelUpdates &&
                w._x_pendingModelUpdates.splice(
                  w._x_pendingModelUpdates.indexOf(tt),
                  1
                );
            });
        }
  ...
  p("cloak", (t) =>
    queueMicrotask(() => m(() => t.removeAttribute(O("cloak"))))
  );
  It(() => `[${O("init")}]`);
  p(
    "init",
  ...
  p("show", (t, { modifiers: e, expression: r }, { effect: n }) => {
    ...
    n(() =>
      i((f) => {
        (!u && f === l) ||
          (e.includes("immediate") && (f ? a() : o()), c(f), (l = f), (u = !1));
      })
    );
  });
          ...
          if (s.has(f)) {
            ...
            d._x_refreshXForScope(b),
              u.nextElementSibling !== d &&
                (u.nextElementSibling && d.replaceWith(u.nextElementSibling),
                u.after(d)),
              (u = d),
              d._x_currentIfEl &&
                (d.nextElementSibling !== d._x_currentIfEl &&
                  u.after(d._x_currentIfEl),
                (u = d._x_currentIfEl));
            return;
          }
  ...
  p("if", (t, { expression: e }, { effect: r, cleanup: n }) => {
    t.tagName.toLowerCase() !== "template" &&
      E("x-if can only be used on a <template> tag", t);
    let i = _(t, e),
      o = () => {
